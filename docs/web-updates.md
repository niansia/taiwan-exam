...
目前的 ZIP 是 9 月 24 日替換後的版本（SHA-256 `abd409e726c9b3d1a2a48786b41eac3236f842437801920a892efa3a8f017b30`，8,661,574 位元組，101 個檔案），與解壓內容通過 Windows Defender 與 Windows 附件檢查。維護者已確認替換後的 ZIP Chrome 下載正常，並在 Claude 與 ChatGPT 上傳成功（替換前的 ZIP `cac5344f…df74e3a`，8,660,975 位元組，也曾分別確認）。[下載 2026.09.22.25 ZIP](https://github.com/niansia/taiwan-exam/releases/download/hosted-2026.09.22.25/taiwan-exam-hosted-2026.09.22.25.zip)；security.json 與 browser.json 在 [Release](https://github.com/niansia/taiwan-exam/releases/tag/hosted-2026.09.22.25) 頁面。已安裝的舊 Skill 請重新下載替換。
