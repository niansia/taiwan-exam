...
| 你用的 AI | 下載這個檔案 | 接著看 |
| --- | --- | --- |
| **Claude**（claude.ai） | [Skill ZIP](https://github.com/niansia/taiwan-exam/releases/download/hosted-2026.09.22.20/taiwan-exam-hosted-2026.09.22.20.zip) | [Claude](#claude) |
| **ChatGPT**，左側欄有 **Plugins**，裡面有 **Skills** 分頁 | [Skill ZIP](https://github.com/niansia/taiwan-exam/releases/download/hosted-2026.09.22.20/taiwan-exam-hosted-2026.09.22.20.zip) | [ChatGPT](#chatgpt) |
...
1. 下載 [Skill ZIP](https://github.com/niansia/taiwan-exam/releases/download/hosted-2026.09.22.20/taiwan-exam-hosted-2026.09.22.20.zip)，不要解壓縮。
2. 開啟 [Claude](https://claude.ai/)，依序點 **Customize → Skills → ＋ → Create skill → Upload a skill**。
3. 選剛下載的 `taiwan-exam-hosted-2026.09.22.20.zip`，按 **Save**。
...
1. 開啟[七科版型下載頁](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/index.html)，找到要出的科目，分別按「**下載題本版型**」和「**下載詳解版型**」。
...
正確的考卷，封面和每頁頁首會和版型一模一樣（可在[七科版型下載頁](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/index.html)開啟當科版型對照）：字型、作答注意事項、劃記範例、頁首位置都相同，只有年份、考試名稱和頁碼不同。如果明顯不一樣，代表 AI 沒有套用原始模板，只是照著畫，這份不能用。請在同一個對話貼上：
...
如果出卷對話能執行 Python、讀寫檔案，可以額外附上 [Skill ZIP](https://github.com/niansia/taiwan-exam/releases/download/hosted-2026.09.22.20/taiwan-exam-hosted-2026.09.22.20.zip)，並加上這段：
...
**目前版本：知識檔與 Skill ZIP 皆為 2026.09.22.20（ZIP 內建七科模板與版型）；七科版型 2026.09.22.20。** [看更新紀錄](docs/web-updates.md)
...
每科都有「題本版型」和「詳解版型」。Skill ZIP 已內建全部版型；用專案或 Gem 的人再到[下載頁](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/index.html)按當科兩個下載按鈕，出卷時一起附給 AI。下表保留直接預覽連結，也可用來對照交付的考卷。

| 科目 | 題本版型 PDF | 詳解版型 PDF |
| --- | --- | --- |
| 國綜 | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/chinese-questions.pdf) | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/chinese-solutions.pdf) |
| 英文 | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/english-questions.pdf) | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/english-solutions.pdf) |
| 數 A | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/math-a-questions.pdf) | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/math-a-solutions.pdf) |
| 數 B | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/math-b-questions.pdf) | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/math-b-solutions.pdf) |
| 自然 | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/science-questions.pdf) | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/science-solutions.pdf) |
| 社會 | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/social-questions.pdf) | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/social-solutions.pdf) |
| 國寫 | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/writing-questions.pdf) | [開啟／下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/writing-solutions.pdf) |
...
[七科版型下載](https://niansia.github.io/taiwan-exam/layout-examples/2026.09.22.20/index.html) · [最新修正與難度設定](docs/web-updates.md)
