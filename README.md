...
| 你用的 AI | 下載這個檔案 | 接著看 |
| --- | --- | --- |
| **Claude**（claude.ai） | [Skill ZIP](https://github.com/niansia/taiwan-exam/releases/download/hosted-2026.09.22.13/taiwan-exam-hosted-2026.09.22.13.zip) | [Claude](#claude) |
| **ChatGPT**，左側欄有 **Plugins**，裡面有 **Skills** 分頁 | [Skill ZIP](https://github.com/niansia/taiwan-exam/releases/download/hosted-2026.09.22.13/taiwan-exam-hosted-2026.09.22.13.zip) | [ChatGPT](#chatgpt) |
...
1. 下載 [Skill ZIP](https://github.com/niansia/taiwan-exam/releases/download/hosted-2026.09.22.13/taiwan-exam-hosted-2026.09.22.13.zip)，不要解壓縮。
2. 開啟 [Claude](https://claude.ai/)，依序點 **Customize → Skills → ＋ → Create skill → Upload a skill**。
3. 選剛下載的 `taiwan-exam-hosted-2026.09.22.13.zip`，按 **Save**。
...
如果出卷對話能執行 Python、讀寫檔案，可以額外附上 [Skill ZIP](https://github.com/niansia/taiwan-exam/releases/download/hosted-2026.09.22.13/taiwan-exam-hosted-2026.09.22.13.zip)，並加上這段：
...
**目前版本：知識檔與 Skill ZIP 皆為 2026.09.22.13（ZIP 內建七科模板與版型）；七科版型 2026.09.22.6。** [看更新紀錄](docs/web-updates.md)
