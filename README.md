...
[**下載安裝**](#第-1-步安裝) · [**開始出卷**](#第-3-步出卷) · [**版型預覽**](#七科版型預覽) · [**常見問題**](#卡住了怎麼辦) · [**更新紀錄**](docs/web-updates.md)
...
| **會考** | 🧪 資料與流程已建立，網頁版 ZIP 尚未提供 | 國文、英語、數學、自然、社會、寫作測驗 |
| **分科測驗** | 🗓️ 規劃中 | — |

新的考試推出時會在這裡和[更新紀錄](docs/web-updates.md)公告，各考試會有各自的下載檔。
