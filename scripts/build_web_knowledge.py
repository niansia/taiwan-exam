...
def source_paths(root: Path = ROOT) -> list[Path]:
    ...
    paths.append(root / "scripts" / "validate_math_layout_contract.py")
    paths.append(root / "scripts" / "hosted_density.py")
    paths.append(root / "scripts" / "hosted_bundles.py")
    ...
    paths.append(root / "scripts" / "validate_natural_layout_contract.py")
