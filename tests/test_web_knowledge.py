...
def test_hosted_template_fetcher_is_packaged_and_embedded(tmp_path):
    ...
    for helper in ("compose_hosted_pdf.py", "inspect_hosted_pdf.py", "check_hosted_run.py",
                   ...
                   "hosted_item_triage.py", "hosted_subject_gates.py", "answer_key_patterns.py", "validate_chinese_layout_contract.py", "validate_visual_item_contract.py", "validate_source_grounding.py", "validate_english_layout_contract.py",
